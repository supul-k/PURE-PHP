...
function validate () {
 ...
 document.getElementById("fnameError").innerHTML = "You must enter valid first name";
  }
 ...
 document.getElementById("lnameError").innerHTML = "You must enter valid last name";
 result=false;
  }
  if (lastname.match(/^[a-zA-Z]+$/)){
 ...
 result=false;
  ...
  document.getElementById("streetError").innerHTML = "You must enter valid street address";
  result=false;
    }
 ...
 document.getElementById("suburbError").innerHTML = "You must enter valid suburb";
 result=false;
    }
 ...
 result=false;
   ...
   if (document.getElementById("states").value == "none") {
    document.getElementById("stateError").innerHTML = "You must select your state";
	result=false
    }
  if (document.getElementById("states").value != "none") {
 ...
 var otherskilltexted = document.getElementById("otherskillstext").value;
  ...
  if ((otherSkillsCheckbox) && (otherskilltexted == "")){
		 document.getElementById("otherskillError").innerHTML = "You must enter your other skills";
		 result=false;
...
if (htmlcss || javascript || python || programmingjava || programmingc || sql || mongodb || otherSkillsCheckbox) {
           	 document.getElementById("skillError").innerHTML = "";
            result = false;
    } 
	else {
		 document.getElementById("skillError").innerHTML = "Please select at least one skill";
	}
	...
	if (male || female ) {
	  ...
	  var dob = document.getElementById("dateofbirth").value;
  var dobRegex = /(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[13-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})/;
  ...
  if (!dobRegex.test(dob)) {
    ...
    return false;
	  ...
	  document.getElementById("bodError").innerHTML = "Please enter a valid date of birth in dd/mm/yyyy format";
    //alert("Please enter a valid date of birth in dd/mm/yyyy format.");
    return false;
  }
  
  if (age < 15 || age > 80) {
   document.getElementById("bodError").innerHTML = "you must be in 15-80 age for this form";
    return false;
  }
return result;
...
function setJobRefNumber() {
  ...
  const jobRefField = document.getElementById("refNumber");
  jobRefField.value = refNumber;
